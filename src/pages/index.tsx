...
export default function Home() {
  ...
  function showUserModal() {
    (document.getElementById("username_modal") as HTMLDialogElement).showModal();
  }
  ...
  async function onUsername(event: FormEvent<HTMLFormElement>) {
    ...
    if (userId == null)
      return (document.getElementById("username_modal") as HTMLDialogElement).showModal();
    ...
    (document.getElementById("username_modal") as HTMLDialogElement).close();
    // ...
  }
